...
// 		zenTaoInsertUser := "INSERT IGNORE INTO zt_user(id,company,account,password,realname,role,commiter,avatar,nature,analysis,strategy) values (?,?,?,?,?,?,?,?,?,?,?)"

// 		r, err := db2.Exec(zenTaoInsertUser, u.Id, u.Company, u.Account, u.Password, u.RealName, u.Role, 1, 1, 1, 1, 1)
// 		if err != nil {
...
// 		// 2为研发者权限
// 		r1, err := db2.Exec(zenTaoinsertUserGroup, u.Account, 2, nil)
// 		if err != nil {
// 			fmt.Printf("user.go | KkbUserLookUp | db2.Exec -> zenTaoinsertUserGroup failed, err:%v\n", err)
// 		}
// 		fmt.Println(r1.LastInsertId())
